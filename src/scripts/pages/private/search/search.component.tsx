...
export function SearchComponent() {
  ...
  // Telas menores que 900px: mapa some e mostramos botão "Abrir mapa" (padrão da plataforma)
  ...
  useEffect(() => {
    ...
    Object.keys(cityToCodeMap).length,
    defaultCityStateCode,
  ]);
            ...
            {!loading && (
              <Box
                sx={{
                  ...
                  paddingBottom: isMapHiddenScreen

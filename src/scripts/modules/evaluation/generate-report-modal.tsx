...
export function GenerateReportModal({
  ...
  useEffect(() => {
    if (open && selectedProperties.length > 0) {
      ...
      if (myCompanyData) {
        initialData.company = {
          name: myCompanyData.name || initialData.company.name,
          logo:
            myCompanyData.profile?.imageURL || initialData.company.logo || "",
          address:
    ...
    // myCompanyData omitido de propósito: pré-preenche só na abertura do modal, sem resetar ao revalidar SWR
          ...
          >
            ...
            <Box
              sx={{
                ...
                display: isSmallScreen && viewMode !== "form" ? "none" : "flex",
                flexDirection: "column",
                overflow: "hidden",
